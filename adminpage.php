				...
				<div class="col-md-8">
					...
					<div class="bg-warning">
						<form method="post" class="table-responsive p-3">
							...
							<input type="submit" name="submit_notice" class="mt-4 btn btn-outline-primary" name="post_button" value="Broadcast">
						</form>
					</div>
				</div>
				<div class="col-md-4">
					...
					<div class="bg-warning">
						<form method="post" class="embed-responsive p-3" enctype="multipart/form-data">
							...
							<input type="submit" name="upload_doc" class="mt-4 btn btn-outline-primary" value="Upload">
						</form>
					</div>
				</div>
			</div>
